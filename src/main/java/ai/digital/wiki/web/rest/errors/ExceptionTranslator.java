...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ai.digital.wiki.service.EmailAlreadyUsedException ||
            ex instanceof ai.digital.wiki.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof ai.digital.wiki.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "ai.digital.wiki");
    }
}
